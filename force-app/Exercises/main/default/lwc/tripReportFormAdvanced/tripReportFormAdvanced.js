        ...
        if (!this.recordId) {
            ...
            createRecord(recordInput)
                ...
                .catch(error => {
                    ...
                    const errorBody = (errors.length) ? errors[0] : 'There was a problem creating your record.';
            ...
            updateRecord(recordInput)
                ...
                .catch(error => {
                    const errors = reduceErrors(error);
                    const errorBody = (errors.length) ? errors[0] : 'There was a problem updating your record.';
